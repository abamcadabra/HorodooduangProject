...
public class TarotPredictionLuck extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            List<Map<String, String>> cards = databaseHelper.getCardByImageIdLuck(selectedCard, language);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TarotPredictionLuck.this, TarotTopic.class);
