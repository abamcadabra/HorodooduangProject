...
public class TarotPredictionHealth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            List<Map<String, String>> cards = databaseHelper.getCardByImageIdHealth(selectedCard, language);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TarotPredictionHealth.this, TarotTopic.class);
