...
public class TarotPredictionCareer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            List<Map<String, String>> cards = databaseHelper.getCardByImageId(selectedCard, language);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TarotPredictionCareer.this, TarotTopic.class);
