...
public class TarotPredictionMoney extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            List<Map<String, String>> cards = databaseHelper.getCardByImageIdMoney(selectedCard, language);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TarotPredictionMoney.this, TarotTopic.class);
